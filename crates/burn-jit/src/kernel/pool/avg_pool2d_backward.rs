use crate::{
    codegen::{
        dialect::gpu::{gpu, Elem, IntWidth, Scope, Variable, Visibility},
...
impl AvgPool2dBackwardComputeShader {
    fn expand(self, scope: &mut Scope) {
        ...
        let begin_h = scope.create_local(Elem::UInt(IntWidth::W32));
        let begin_w = scope.create_local(Elem::UInt(IntWidth::W32));
        ...
        let ih_diff = scope.create_local(Elem::UInt(IntWidth::W32));
        let iw_diff = scope.create_local(Elem::UInt(IntWidth::W32));
        let count_int = scope.create_local(Elem::UInt(IntWidth::W32));
    ...
    fn loop_ranges(
        ...
        let signed_ih = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_iw = scope.create_local(Elem::Int(IntWidth::W32));

        let signed_pool_stride_0 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_pool_stride_1 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_dilation_0 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_dilation_1 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_padding_0 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_padding_1 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_kernel_size_0 = scope.create_local(Elem::Int(IntWidth::W32));
        let signed_kernel_size_1 = scope.create_local(Elem::Int(IntWidth::W32));
        ...
        let oh_start_tmp = scope.create_local(Elem::Int(IntWidth::W32));
        let ow_start_tmp = scope.create_local(Elem::Int(IntWidth::W32));
        ...
        let oh_end_tmp = scope.create_local(Elem::Int(IntWidth::W32));
        let ow_end_tmp = scope.create_local(Elem::Int(IntWidth::W32));
