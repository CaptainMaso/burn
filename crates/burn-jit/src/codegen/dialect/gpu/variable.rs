...
impl Variable {
    ...
    pub fn item(&self) -> Item {
        match self {
            ...
            Variable::Id => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::Rank => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::LocalInvocationIndex => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::LocalInvocationIdX => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::LocalInvocationIdY => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::LocalInvocationIdZ => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupIdX => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupIdY => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupIdZ => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::GlobalInvocationIdX => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::GlobalInvocationIdY => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::GlobalInvocationIdZ => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupSizeX => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupSizeY => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::WorkgroupSizeZ => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::NumWorkgroupsX => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::NumWorkgroupsY => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
            Variable::NumWorkgroupsZ => Item::Scalar(Elem::UInt(super::IntWidth::W32)),
        }
    }
}
